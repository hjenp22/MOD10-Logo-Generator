describe("Triangle tests", () => {
    ...
    it("should return the text", () => {
      const shape = new Triangle("Heart");
      expect(shape.text).toEqual("Heart");
    });
  
    it("should return the svg", () => {
      const shape = new Triangle("Heart", "red", "blue");
  ...
  describe("Circle tests", () => {
    ...
    it("should return the text", () => {
      const shape = new Circle("Heart");
      expect(shape.text).toEqual("Heart");
    });
  
    it("should return the svg", () => {
      const shape = new Circle("Heart", "red", "blue");
      expect(shape.render()).toEqual(
  ...
  describe("Square tests", () => {
    ...
    it("should return the text", () => {
      const shape = new Square("Heart");
      expect(shape.text).toEqual("Heart");
    });
  
    it("should return the svg", () => {
      const shape = new Square("Heart", "red", "blue");
      expect(shape.render()).toEqual(
